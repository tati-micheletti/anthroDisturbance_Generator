...
- `seismicLineGrids`: How many grids concomitantly should the model produce when creating  seismic lines? Defaults to `NULL`, which auto-estimates a value from the seismic lines in the study area together with the seismic rate and run interval. If seismic disturbance is being produced over the expected amount, please provide smaller values.
